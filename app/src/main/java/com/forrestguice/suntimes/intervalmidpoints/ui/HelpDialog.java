...
public class HelpDialog extends BottomSheetDialogFragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup parent, @Nullable Bundle savedState)
    {
        ...
        txtView = (TextView) dialogContent.findViewById(R.id.txt_help_content);
        buttonFrame = dialogContent.findViewById(R.id.dialog_buttons);
        neutralButton = (Button) dialogContent.findViewById(R.id.dialog_button_neutral);
        if (savedState != null) {
